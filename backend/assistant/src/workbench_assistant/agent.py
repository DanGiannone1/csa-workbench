...
from .product_prompt import system_prompt, user_prompt_line
...
SYSTEM_PROMPT = system_prompt(allow_skill_loader=False)
...
class AgentSession:
    ...
    async def __aenter__(self) -> "AgentSession":
        ...
        self._session = await self._client.create_session(
            ...
            provider=provider,
            **reasoning_kwargs,
            system_message={"mode": "replace", "content": SYSTEM_PROMPT + user_prompt_line(self._user_id)},
