...
use [the skill-evaluation guide](skill-evals.md).
...
| Skill laboratory | `python -m scripts.workbench eval waza`, `tests/evals/waza/**` | Separate lane: skills tested in isolation with mocked product actions; see [the skill-evaluation guide](skill-evals.md) |
