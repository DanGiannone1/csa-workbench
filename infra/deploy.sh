...
verify_inventory() {
  local apps deployments identities resources system_topics system_topic_name system_topic_subscriptions acr azure_open_ai foundry_project cosmos storage vnet private_endpoints private_dns_zones managed_environment network_security_groups cosmos_dns_links storage_dns_links openai_dns_links cognitive_services_dns_links ai_services_dns_links cosmos_dns_groups storage_dns_groups openai_dns_groups cosmos_dns_records storage_dns_records openai_dns_records cognitive_services_dns_records ai_services_dns_records frontend_principal api_principal runtime_principal assignments cosmos_sql_assignments
